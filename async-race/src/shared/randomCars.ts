export function randomCar(): { [key: string]: string } {
    ...
    const arrOfCarsFirstNames = ['Mersedes', 'Mazda', 'Toyota', 'Tesla', 'BMW', 'Audi', 'Skoda', 'Lada', 'Ferrari', 'Porsche'];
    const arrOfCarsLastNames = ['Land Cruiser', 'F-50', 'CX-5', 'Model S', 'SuperB', 'Vesta', 'F10', 'GLS', 'TT', 'E-tron'];
